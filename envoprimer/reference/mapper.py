...
class CoordinateMapper:
    ...
    def reference_to_alignment(
        ...
        if coordinate.start not in self.ref_to_aln:
            raise KeyError(
                f"Reference position {coordinate.start} not found"
            )

        if coordinate.end not in self.ref_to_aln:
            raise KeyError(
                f"Reference position {coordinate.end} not found"
            )
